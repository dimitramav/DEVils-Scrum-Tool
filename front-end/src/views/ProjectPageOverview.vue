            ...
            <b-col>
                <b-row>
                    ...
                    <b-col v-if="(projectOverview.project.isDone === false )" class="text-right">
                        <b-dropdown v-if="isProductOwner()===true" class="pcsprint"
                                    style="margin-left: 45px; height: 35px; width: 35%; left:10%" size="mr-sm-2" right>
                            <template slot="button-content" class="pcsprint">
                                <b-img src="https://cdn3.iconfinder.com/data/icons/3d-printing-icon-set/512/Edit.png"
                                        style="width:20px; margin-right: 5px;" /> Edit Project
                            </template>
                            <template>
                                <b-form inline style="margin: 10px;" @submit="updateProject">
                                    ...
                                    <div>
                                        <b-form-input id="inputLive" v-model.trim="form.deadlineDate" type="date"
                                                :state="dateState"></b-form-input>
                                        <b-form-invalid-feedback id="inputLiveFeedback">
                                                Project's Deadline cannot be a past or current date.
                                        </b-form-invalid-feedback>
                                    </div>
                                    <b-button letiant="success" type="submit" :disabled="dateState===false"
                                            style="margin-top: 10px; width: 100%;">Save changes</b-button>
                                </b-form>
                            </template>
                        </b-dropdown>
                    </b-col>
            ...
            <b-col>
                    ...
                    <b-container fluid>
                        <b-jumbotron style="background-color: #f7f7f7;">
                            <div v-if="(projectOverview.currentSprintNum === 0)">
                                <b-button class="pcsprint" letiant="primary" :to="{name: 'NewSprint', params: {id:$route.params.id}}">
                            ...
                            <div v-else>
                                ...
                                <br>
                                <div v-if="( diffDays < 0)">
                                    <b-button letiant="primary" :to="{name: 'NewSprint', params: {id:$route.params.id}}">
                                            Create New Sprint! </b-button>
                                </div>
                                <div v-else>
                                    <b-button class="pcsprint" letiant="success" :to="{name: 'SprintBacklog', params: {id:$route.params.id}}">
                                            Go to Sprint Page </b-button>
                                </div>
                            </div>
                        </b-jumbotron>
                    </b-container>
                ...
                <div v-else style="height: 100%">
                    <b-container fluid>
                        <b-jumbotron>
                            <b-row>
                                <p class="pcsprint" style="font-size: 180%; color: #264d73">
                                        This Project has finished... Go back to Home Page to create a new one! </p>
                            </b-row>
                ...
                <b-container fluid>
                    <b-jumbotron style="background-color: #f7f9fc;">
                        ...
                        <template>
                            <div v-if="(projectOverview.project.isDone === false )">
                                <b-form v-if="isProductOwner()===true" inline @submit="addMembers">
                                    ...
                                    <b-form-group id="emailForm" label-for="email" :invalid-feedback="validEmail===false ? 'Invalid User' : ''">
                                        <b-form-input class="mb-2 mr-sm-2 mb-sm-0" id="emailInput" type="email" v-model="newMember.mail"
                                                @change="checkEmail" :state="validEmail" placeholder="email" required>
                                        </b-form-input>
                                    </b-form-group>
                                    as&nbsp;
                                    <b-form-select v-model="newMember.role" :options="opts" class="mb-2 mr-sm-2 mb-sm-0"
                            ...
                            <b-row>
                                <b-col cols="11">
                                    <b-alert class="pcsprint" variant="success" :show="projectOverview.showAlert"
                                            dismissible>Invitation send!</b-alert>
                                </b-col>
                            </b-row>
                        </template>
                    </b-jumbotron>
...
export default {
    ...
    methods: {
        ...
        updateProject() {
            const self = this;
            let data = {
                idProject: this.projectOverview.project.idProject,
