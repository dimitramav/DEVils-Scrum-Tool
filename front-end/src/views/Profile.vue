...
<b-container class="Navigation" fluid>
    ...
    <br>
    <b-card v-if="userInfos.mail != null" img-src="https://picsum.photos/600/300?image=445" img-alt="Image"
                img-top tag="article" style="max-width:19rem;margin: 0 auto;float: none; margin-bottom: 10px;" class="mb-2">
    ...
    <b-card v-else img-src="https://picsum.photos/600/300?image=1062" img-alt="Image" img-top tag="article"
                style="max-width:19rem;margin: 0 auto;float: none; margin-bottom: 50%;" class="mb-2">
        <div style="text-align: left;">
