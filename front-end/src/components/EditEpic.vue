        ...
        <div class="text-left" id="updateEpic">
            <b-form>
                <b-form-group label="Title:">
                    <b-form-input :id="'title'+idPBI" type="text" v-model="updateEpic_form.title" required>
                    </b-form-input>
                </b-form-group>
                <b-form-group label="Description:">
                    <b-form-input :id="'desc'+idPBI" type="text" v-model="updateEpic_form.desc" required>
                    </b-form-input>
                </b-form-group>
    ...
    methods: {
        ...
        updateEpic() {
            ...
            let data = {
                ...
                priority: self.priorityToNumber(this.updateEpic_form.selected),
            ...
            axios.put(this.$url + 'users/' + localStorage.getItem('userId') + '/projects/' + this.currentProject_id
                ...
                .then(function(response) {
                    if (response.data.error) {
                        ...
                        console.log(response.data.results);
                        self.$emit('edit_epic', self.idPBI, response.data.results.title, response.data.results.description,
                                    self.priorityToString(response.data.results.priority));
