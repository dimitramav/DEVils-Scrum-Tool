    ...
    methods: {
        ...
        watchedNotification(functionality, notificationItem) {
            ...
            if (functionality === 'accept') {
                ...
                axios.post(this.$url + 'users/' + localStorage.getItem('userId') + '/projects/' +
                            notificationItem.Project_id + '/members', data, {
                        headers: {
                            "auth": localStorage.getItem('auth_token'),
                            "Content-Type": 'application/json'
                        }
            ...
            if (notificationItem.type === "Accept/Decline") {
                ...
                if (functionality === 'accept') {
                    ...
                    this.$router.push({
                        path: '/project/' + notificationItem.Project_id + '/overview'
                    });
                }
            }
        },
