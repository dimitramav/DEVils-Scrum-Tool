...
insert into User (username, password, mail, firstname, lastname, isAdmin, numProjects)
	values ('orestis', 'garmpis', 'sdi1400025@di.uoa.gr', 'Orestis', 'Garmpis', True, 2);
insert into User (username, password, mail, firstname, lastname, isAdmin, numProjects)
	values ('kostas', 'kotronis', 'sdi1400074@di.uoa.gr', 'Kostas', 'Kotronis', False, 1);
select * from User;
