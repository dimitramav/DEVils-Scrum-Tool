...
describe('Notifications', () => {
    ...
    it('Notification data properties', () => {
        expect(wrapper.vm.notificationStruct.idNotification).toBeNull()
        expect(wrapper.vm.notificationStruct.Project_id).toBe(0)
        expect(wrapper.vm.notificationStruct.projectTitle).toBeNull()
        expect(wrapper.vm.notificationStruct.role).toBeNull()
        expect(wrapper.vm.notificationStruct.FromUsername).toBeNull()
        expect(wrapper.vm.notificationStruct.ToUserEmail).toBe('')
