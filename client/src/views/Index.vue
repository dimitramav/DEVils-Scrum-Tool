        ...
        <div v-else>
            <b-container class="Navigation" fluid>
                ...
                <b-jumbotron v-show="gotProjects && !totalNumOfCurProjects">
                    ...
                    <b class="pcsprint">No projects yet. Start creating!</b
                    ><br /><br />
                    <b-dropdown
                        id="ddown1"
                        variant="info"
                        ...
                        >
                            ...
                            <div>
                                ...
                                <b-form-invalid-feedback id="inputLiveFeedback">
                                    Project's Deadline cannot be a past or
                                    current date.
                ...
                <b-container>
                    <div v-show="totalNumOfCurProjects">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    Project's Deadline cannot be
                                                    a past or current date.
                                                </b-form-invalid-feedback>
                                            </div>
                                            <b-button
                                                variant="success"
                        ...
                        <b-row>
                            <b-card-group
                                v-for="cur_project in currentProjects"
                                :key="cur_project.idProject"
                                deck
                        ...
                        <b-row>
                            ...
                            <b-col>
                                <template>
                                    <div>
                                        <b-pagination
                                            v-if="totalNumOfCurProjects"
                                            size="md"
                                            :total-rows="totalNumOfCurProjects"
                                            v-model="currentPageCurrent"
                                            :per-page="recordsPerPageCurrent"
                                        >
                                        </b-pagination>
                                    </div>
                                </template>
                    ...
                    <div v-if="totalNumOfDoneProjects !== 0">
                        ...
                        <b-row>
                            <b-card-group
                                v-for="done_project in doneProjects"
                                :key="done_project.idProject"
                                deck
                            >
                                <b-card
                                    img-top
                                    ...
                                    style="max-width: 15rem;"
                                    class="mb-2"
                                    img-src="https://picsum.photos/600/300/?image=1068"
                                    img-alt="Image"
                                >
                                    <h3 class="pcsprint">
                                        {{ done_project.title }}
                            ...
                            <b-col>
                                <template>
                                    <div>
                                        <b-pagination
                                            size="md"
                                            :total-rows="totalNumOfDoneProjects"
...
import IndexDefault from './IndexDefault.vue'
...
export default {
    ...
    data() {
        return {
            ...
            recordsPerPageCurrent: this.$recordsPerPage,
            totalNumOfDoneProjects: 0,
            currentPageDone: 1,
            recordsPerPageDone: this.$recordsPerPage,
        }
    },
    methods: {
        gotoSignIn() {
            ...
            axios
                .get(
                    this.$url +
                        ...
                        '/projects?isDone=false&currentPage=' +
                        self.currentPageCurrent,
                    {
                        headers: {
            ...
            axios
                .get(
                    this.$url +
                        'users/' +
                        localStorage.getItem('userId') +
                        '/projects?isDone=true&currentPage=' +
                ...
                .then(function (response) {
                    if (response.data.error) {
                        if (response.data.error === 'Unauthorized user') {
                            ...
                            response.data.error === 'Unauthorized projects'
                        ) {
